...
fn display_debug_crash() {
    display(
        ...
        "crash::target",
        "",
        "Encountered a failure while not generating coverage or replaying. A buggy Debug \
...
fn display_debug_hang() {
    display(
        ...
        "hang::target",
        "",
        "Encountered a timeout while not generating coverage or replaying. A buggy Debug \
         implementation perhaps?",
    );
}
